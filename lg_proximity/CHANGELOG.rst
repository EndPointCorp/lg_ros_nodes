...
1.0.21 (2016-04-06)
-------------------
* maxbotix: set a default device path
  Udev now labels maxbotix devices /dev/maxbotix.%n, since there should
  just be one plugged in, we can safely assume that the path will be
  maxbotix.0.
* Contributors: Jacob Minshall
...
* LINT and cleanup maxbotix package
* Bumped version
* added test mode capability to maxbotix
...
* Add device_path and baud_rate to maxbotix package
* Fix params in rfreceiver and maxbotix
  Use private parameters.
* Add device_path and baud_rate to maxbotix package
* PEP8 and modelines for catkin packages
* Update README for maxbotix
* catkin: initial debian packaging configs.
* Add proximity sensor driver
* Contributors: Jacob Minshall, Kiel Christofferson, Matt Vollrath, Wojciech Ziniewicz
