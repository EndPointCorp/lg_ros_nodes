...
def main():
    ...
    default_viewport = rosparam.get('default_viewport', None)
    if not default_viewport:
        raise DefaultViewportException("Could not get default viewport - please set the rosparam")
    ...
    on_new_scene(onboard_router.handle_scene)
