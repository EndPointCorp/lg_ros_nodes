...
class TestAdhocBrowser(unittest.TestCase):
    ...
    def test2a_chrome_extension_initialization_with_two_extensions(self):
        ...
        wait_for_assert_equal(lambda : len(self.director_window_ready_mock.messages), 1, timeout=self.preloading_grace_time + 15)
    ...
    def test3_chrome_commandline_argument_passing(self):
        ...
        wait_for_assert_equal(lambda : len(list(self.get_browsers_thru_service('center').items())), 1, self.preloading_grace_time)
    ...
    def test6_chrome_persistence(self):
        ...
        rospy.sleep(self.message_emission_grace_time)
        wait_for_assert_equal(lambda : len(self.director_scene_mock.messages), 1, self.preloading_grace_time)
        ...
        self.director_publisher.publish(self.message_factory._get_message('test_one_browser_on_center_msg'))
        rospy.sleep(self.message_emission_grace_time)
        wait_for_assert_equal(lambda : len(self.director_scene_mock.messages), 2, self.preloading_grace_time)
        self.assertEqual(len(self.director_window_ready_mock.messages), 0)
        self.assertEqual(len(self.director_ready_mock.messages), 0)
        self.assertEqual(self.browser_service_mock_center.messages[0].browsers[0].id, 'gzJERcJ')
    ...
    def test7_adhoc_browser_preloading(self):
        ...
        rospy.sleep(self.message_emission_grace_time)
        wait_for_assert_equal(lambda : len(self.director_window_ready_mock.messages) > 0, True, self.preloading_grace_time + 15)
        self.assertEqual(len(self.director_scene_mock.messages), 1)
        ...
        self.director_publisher.publish(self.message_factory._get_message('test_one_browser_with_preloading_msg'))
        rospy.sleep(self.message_emission_grace_time)
        wait_for_assert_equal(lambda : len(self.director_ready_mock.messages), 2, self.preloading_grace_time)
        ...
        wait_for_assert_equal(lambda : len(self.director_ready_mock.messages), 3, self.preloading_grace_time)
        browsers_on_center = self.get_browsers_thru_service('center')
        self.assertEqual(len(browsers_on_center), 1)
    ...
    def test8_adhoc_browser_preloading_mix(self):
        ...
        wait_for_assert_equal(lambda : len(self.director_ready_mock.messages), 1, self.preloading_grace_time + 15)
        ...
        wait_for_assert_equal(lambda : len(self.director_ready_mock.messages), 2, self.preloading_grace_time + 15)
        ...
        wait_for_assert_equal(lambda : len(self.director_ready_mock.messages), 3, self.preloading_grace_time + 15)
    ...
    def test9_adhoc_browser_custom_preload_event(self):
        ...
        wait_for_assert_equal( lambda : len(self.director_ready_mock.messages), 1, self.preloading_grace_time)
