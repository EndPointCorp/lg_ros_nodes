...
catkin package set up:
    catkin_create_pkg lg_video std_msgs rospy


catking_make
source catkin/devel/setup.bash
roslaunch lg_video/launch/dev.launch
rostopic list
rostopic pub --once /lg_video/presence std_msgs/Bool -- True
...
def listener():
    ...
    rospy.Subscriber("/lg_video/presence", Bool, presenter)
    rospy.Subscriber("/lg_video/control", String, controller)
    rospy.loginfo("lg_video started.")
    rospy.spin()
